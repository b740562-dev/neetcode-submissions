...
// ---------------------------------------------------------------------------------------------------------------
        ...
        // on reaching the ind n return 0---no more elements present to create the lis !!!

        for(int curr=n-1;curr>=0;curr--){
            // prev will be from -1 to ind-1th index !!!!
            // we will do a +1 to all prev ind to maintain the indices validity !!!! 
